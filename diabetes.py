...
Original file is located at
    https://colab.research.google.com/drive/1azaOUtr8d0yHoksN5KscU-jjLMLmyifK
"""
...
# checking number of 0 and 1 outcomes
...
sns.countplot(x='Outcome',hue='Outcome',data=df1,palette='cubehelix') #plot the count of number of zeros and ones outcomes
